...
class rmob():
	...
	def getRmobPlot(self):
		...
		dwg.add(dwg.text('Observer:', insert=(203, 11), fill='#505f76', style = "font-size:10px; font-family:Arial"))
		...
		dwg.add(dwg.text(self.stationLat, insert=(255, 11), fill='#61218f', style = "font-size:12px; font-family:Arial"))
		dwg.add(dwg.text(self.stationLon, insert=(255, 26), fill='#61218f', style = "font-size:12px; font-family:Arial"))
